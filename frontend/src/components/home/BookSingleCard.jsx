...
const BookSingleCard = ({ book }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-start items-centergap-x-2">
      ...
      <div className="flex justify-between items-center gap-x-2 mt-2 p-4">
        ...
        <Link to={`/Bookstore/books/details/${book._id}`}>
          <BsInfoCircle className="text-2xl text-green-800 hover:text-black" />
        </Link>
        <Link to={`/Bookstore/books/edit/${book._id}`}>
          <AiOutlineEdit className="text-2xl text-yellow-600 hover:text-black" />
        </Link>
        <Link to={`/Bookstore/books/delete/${book._id}`}>
